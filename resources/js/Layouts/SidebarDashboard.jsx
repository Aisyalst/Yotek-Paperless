...
export default function Sidebar({ isOpen, onClose }) {
        ...
        if (menu.type === 'Dropdown' && menu.children && menu.children.length > 0) {
            ...
            return (
                <li key={menu.id} className="relative list-none">
                    ...
                    {isOpen && (
                        <ul className="ms-5 pl-2 border-l border-zinc-200">
    ...
    return (
        <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-[#ffffff] border-r border-zinc-200 text-[#1a1a1a] flex flex-col transition-transform duration-300 ease-in-out transform ${isOpen ? 'translate-x-0' : '-translate-x-full'
            ...
            <div className="h-16 flex items-center justify-between px-6 border-b border-zinc-200">
                <span>
                    <div className="flex items-center">
                        <img src="https://yogura.com/wp-content/uploads/2026/08/yotek_logo_v3-01.png" alt="" className=" h-10" />
            ...
            <div className="p-4 border-t border-zinc-200 mt-5">
                <p className="text-xs text-[#1a1a1a]">© 2026 PT. Yogura Tekindo</p>
            </div>
        </aside>
    );
}