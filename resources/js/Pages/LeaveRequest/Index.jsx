            ...
            render: (request) => {
                ...
                return (
                    <div className="flex flex-col gap-2">
                        ...
                        {request.request_type === 'Sakit' && !request.has_doctor_note && (
                            <span className="inline-flex w-fit items-center gap-1.5 px-2.5 py-1 rounded-md text-[10px] font-bold bg-yellow-50 text-yellow-600 border border-yellow-200 mt-1">
