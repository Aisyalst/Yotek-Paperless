...
export default function Create({ users = [] }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('leave-entitlements.store'));
    };
    ...
    return (
        <DashboardLayout judulHalaman="Tambah Hak Cuti">
            <Head title="Tambah Hak Cuti" />

            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                <div>
                    <h1 className="text-xl font-bold text-[#1a1a1a]">Tambah Hak Cuti</h1>
                    <p className="text-sm text-gray-600 mt-1">Tambahkan data hak cuti baru untuk karyawan.</p>
                </div>
            </div>
