...
export default function Edit({ dashboardMenu, routes = [], parentMenus = [] }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // Mengirim request PUT ke route update
            ...
            <div className="w-full bg-white border border-zinc-200 rounded-lg shadow-sm p-6">
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div>
                            <h1 className="text-xl font-bold text-zinc-700">Edit Dashboard Menu</h1>
                            <p className="text-sm text-gray-500 mt-1">Update dashboard menu information.</p>
                        </div>
                    </div>
