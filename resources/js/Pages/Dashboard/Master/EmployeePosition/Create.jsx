...
export default function Create() {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('employee-positions.store'));
    };

    return (
        <DashboardLayout judulHalaman="Tambah Jabatan">
            <Head title="Tambah Jabatan" />

            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                <div>
                    <h1 className="text-xl font-bold text-[#1a1a1a]">Tambah Jabatan Karyawan</h1>
                    <p className="text-sm text-gray-600 mt-1">Masukkan detail jabatan karyawan baru.</p>
                </div>
                ...
                <form onSubmit={submit} className="space-y-6 max-w-2xl">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#eaae36] focus:border-transparent transition-all outline-none text-sm"
                            placeholder="Biarkan kosong untuk otomatis ditaruh di akhir"
                            min="1"
                        />
