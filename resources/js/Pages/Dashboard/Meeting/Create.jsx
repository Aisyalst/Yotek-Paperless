...
export default function Create({ rooms = [], divisions = [], roles = [], employees = [] }) {
    ...
    return (
        <DashboardLayout judulHalaman="Tambah Jadwal Meeting">
            <Head title="Tambah Jadwal Meeting" />
            
            <div className="w-full bg-[#ffffff] border border-gray-200 text-[#1a1a1a] rounded-lg shadow-sm p-6">
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div>
                            <h1 className="text-xl font-bold text-[#1a1a1a]">Tambah Jadwal Meeting Baru</h1>
                            <p className="text-sm text-gray-600 mt-1">Buat jadwal meeting baru dan tentukan partisipan.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 pt-4 border-t border-gray-200">
                        ...
                        <SubmitOutlineButton text="Simpan Jadwal" disabled={processing} />
                    </div>
                </form>
            </div>
        </DashboardLayout>
